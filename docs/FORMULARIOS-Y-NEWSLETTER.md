...
El sitio estático envía sus formularios mediante POST HTTPS a FormSubmit. El destinatario es **altumlapaz@gmail.com** y no se incluye ninguna contraseña o clave privada en la web.
